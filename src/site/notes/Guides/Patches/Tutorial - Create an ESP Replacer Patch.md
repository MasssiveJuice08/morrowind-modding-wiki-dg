---
{"dg-publish":true,"permalink":"/guides/patches/tutorial-create-an-esp-replacer-patch/","tags":["Tutorials","Patches","Construction-Set","CSSE","Beginner"]}
---
...
# Tutorial 1:
>[!info] Scenario: 
>![Patches_ESP-Replacer_1_Preview.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_Preview.png) 
>**Scenario:**
...
![Patches_ESP-Replacer_1_DataFiles.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_DataFiles.png)
...
![Patches_ESP-Replacer_Cell_Window.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_Cell_Window.png)
...
>![Patches_ESP-Replacer_1_Conflict2.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_Conflict2.png)
...
>![Patches_ESP-Replacer_1_Conflict3.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_Conflict3.png)
>1. Try this out with other references in the cell - they will either originate from `Morrowind.esm`, `MMW_Patches_ESP-Replacer_1a.esp` or `MMW_Patches_ESP-Replacer_1b.esp`. Be sure not to move any references as otherwise you will make [dirty references]() 
>>For more information on [Show Reference Data]()  see the wiki page
...
![Patches_ESP-Replacer_1_Patching1.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_Patching1.png)
...
>[!figure] New location: 
> ![Patches_ESP-Replacer_1_Moved.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_Moved.png)
...
- [[Guides/Patches/Tutorial - Create an ESP Replacer Patch#Check for floaters and buried objects\|#Check for floaters and buried objects]]
- [[Guides/Patches/Tutorial - Create an ESP Replacer Patch#Check the northmarkers of interior cells\|#Check the northmarkers of interior cells]]
- [[Guides/Patches/Tutorial - Create an ESP Replacer Patch#Cleaning the mod\|#Cleaning the mod]]
- [[Guides/Patches/Tutorial - Create an ESP Replacer Patch#Naming the ESP\|#Naming the ESP]]
...
>![Patches_ESP-Replacer_1_check1.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_check1.png) 
...
>![Patches_ESP-Replacer_1_check2.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_check2.png)
>
...
>> 
>>1. On the one hand, it is unnecessarily adding to the reference count of the cell , so we could delete this to help optimize the cell. 
...
For more information on northmarkers and how to orient them, see the Project Tamriel Wiki article [Interior Guidelines](https://wiki.project-tamriel.com/wiki/Interior_Guidelines#Northmarker)  
...
>3. `West Gash Region -1,2` -- (*if you edited the chokeweed in* [[Guides/Patches/Tutorial - Create an ESP Replacer Patch#Check for floaters and buried objects\|#Check for floaters and buried objects]])
>
...
> 
>>[!example]
>>![Patches_ESP-Replacer_1_DirtyEdit.png](/img/user/Assets/Guides/Patches/Tutorial%20-%20Create%20an%20ESP%20Replacer%20Patch/Patches_ESP-Replacer_1_DirtyEdit.png)
>> 
...
With your ESP Replacer completed, consider whether the name will be identical to the 'original mod', or have a unique name to distinguish it. See [[Guides/Patches/Creating a Patch for an ESP#Conventions\|Creating a Patch for an ESP#Conventions]] for more information.
